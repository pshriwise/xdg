...
// void MOABMetaData::parse_metadata() {
//   this->load_property_data();
// }

// std::string MOABMetaData::get_volume_property(const std::string& property, MeshID vol) const
// {
//   return this->get_volume_property(property, vol, false);
// }

// std::string MOABMetaData::get_surface_property(const std::string& property, MeshID surf) const
// {
//   return this->get_surface_property(property, surf, false);
// }

// // get the given volume property on a given entity handle
// std::string MOABMetaData::get_volume_property(const std::string& property,
//                                               moab::EntityHandle eh) const
// {
//   std::string value = "";
//   if (property == "material_density") {
//     value = volume_material_property_data_eh.at(eh);
//   } else if (property == "material") {
//     value = volume_material_data_eh.at(eh);
//   } else if (property == "density") {
//     value = volume_density_data_eh.at(eh);
//   } else if (property == "importance") {
//     value = volume_importance_data_eh.at(eh);
//   } else if (property == "tally") {
//     value = tally_data_eh.at(eh);
//   } else {
...
// std::string MOABMetaData::get_volume_property(std::string property, int vol,
//                                                bool idx) const {
//   // TODO: Sort out index vs. ID associations
//   // if this is an index query
//   // moab::EntityHandle eh;
//   // if (idx == true) {
//   MeshID eh = mesh_manager()->volume(vol);
//   // } else {
...
// std::string MOABMetaData::get_surface_property(std::string property,
//                                                moab::EntityHandle eh) const {
//   std::string value = "";
//   if (property == "boundary") {
//     value = surface_boundary_data_eh.at(eh);
//   } else if (property == "tally") {
//     value = tally_data_eh.at(eh);
//   } else {
//     std::stringstream ss;
...
// std::string MOABMetaData::get_surface_property(std::string property, int vol,
//                                                 bool idx) const {
//   // if this is an index query
//   // moab::EntityHandle eh;
//   // if (idx == true) {
//   MeshID eh = mesh_manager()->surface(vol);
//   // } else {
...
// void MOABMetaData::parse_material_data() {
...
//   int num_cells = mesh_manager()->num_volumes();
...
//     MeshID eh = mesh_manager()->volume(i);
//     int cellid = eh;
...
// void MOABMetaData::parse_importance_data() {
//   auto importance_assignments = get_property_assignments("importance", 3, ":");

//   int num_vols = mesh_manager()->num_volumes();
...
//     moab::EntityHandle eh = mesh_manager()->volume(i);
...
// void MOABMetaData::parse_tally_volume_data() {
...
// std::string MOABMetaData::to_lower(std::string input) {
//   dagmc_util::lowercase_str(input);
//   return input;
// }

// // parse the boundary data
// void MOABMetaData::parse_boundary_data() {
...
// void MOABMetaData::parse_tally_surface_data() {
...
// MOABMetaData::get_property_assignments(std::string property, int dimension,
...
//   // get initial sizes
//   int num_entities = mesh_manager()->num_ents_of_dimension(dimension);
...
// std::vector<std::string> MOABMetaData::remove_duplicate_properties(
//     std::vector<std::string> properties) {
//   // remove duplicates
...
// std::set<std::string> MOABMetaData::set_remove_rich(
...
//     if (matches.size() > 1) {
//       int smallest = 0;
//       // TODO: Remove dependency on limits, maybe choose a reasonable max. Also constexpr...
...
// std::vector<std::string> MOABMetaData::unpack_string(std::string to_unpack,
//                                                       std::string delimiters) {
...
// std::string MOABMetaData::return_property(std::string property_string,
//                                            std::string property,
...
// std::pair<std::string, std::string> MOABMetaData::split_string(
...
// bool MOABMetaData::try_to_make_int(std::string value) {
